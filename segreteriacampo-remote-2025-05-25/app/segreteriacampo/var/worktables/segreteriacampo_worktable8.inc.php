...
$wt_short_title = 'COMUNICAZIONI RADIO';
$wt_full_title = 'Comunicazioni radio';
...
if (is_object($form->fields['nummessaggio'])) $form->fields['nummessaggio']->defaultvalue = worktable_parse_default_expression('${codice riga}', $form);
    ...
    new form_textbox($form, 'chiamante', 'Chiamante', false, 30, 255, '');

    
    new form_textbox($form, 'chiamato', 'Chiamato', false, 30, 255, '');

    
    new form_textarea($form, 'messaggio', 'Messaggio', true, 10, 80, 1000, '');

    
    new form_textbox($form, 'servizio', 'Servizio', false, 30, 255, '');

    
    new form_static_listbox($form, 'necessariarisposta', 'Necessaria risposta', 'n.d.,No,Sì', false, '');
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,dataora,operatore,nummessaggio,chiamante,chiamato,messaggio,servizio,necessariarisposta,priorit,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,dataora,operatore,nummessaggio,chiamante,chiamato,messaggio,servizio,necessariarisposta,priorit,note';
