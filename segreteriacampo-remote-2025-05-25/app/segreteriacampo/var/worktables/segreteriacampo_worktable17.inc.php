...
$wt_short_title = 'CONTEGGIO PASTI';
$wt_full_title = 'Conteggio pasti';
...
if (is_object($form->fields['data1'])) $form->fields['data1']->defaultvalue = date('Y-m-d');
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,data1,pasto,totalepasti,pastivolontari,pastioperatori,pastiospiti,pastiesterni,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
