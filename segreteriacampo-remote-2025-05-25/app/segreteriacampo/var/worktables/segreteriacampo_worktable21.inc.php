...
$wt_short_title = 'OPERATORI';
$wt_full_title = 'Operatori';
...
$form->fields['provincia']->autosuggest_destfields = 'cognome,nome,organizzazioneentesocieta';
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,cognome,nome,organizzazioneentesocieta,accessodal,accessoal,codicebadge,provincia,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
