...
$wt_short_title = 'EX OSPITI';
$wt_full_title = 'Ex Ospiti';
...
$form->fields['note']->autosuggest_destfields = 'tenda,cognome,nome,annodinascita,codicebadge,ospitedal,sesso';
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,tenda,cognome,nome,annodinascita,codicebadge,ospitedal,ospiteal,sesso,motivazione,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
