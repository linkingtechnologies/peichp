...
$wt_short_title = 'VOLONTARI ATTESI';
$wt_full_title = 'Volontari attesi';
...
if (camila_form_in_update_mode('segreteriacampo_worktable22')) {
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,provincia,organizzazione,cognome,nome,codicefiscale,codicevolontario,datadinascita,cellulare,mansione,responsabile,autista,pranzo,cena,beneficidilegge,dataarrivo,oraarrivo,datapartenza,orapartenza,turno,codiceorganizzazione,servizio,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,provincia,organizzazione,cognome,nome,codicefiscale,codicevolontario,datadinascita,cellulare,mansione,responsabile,autista,pranzo,cena,beneficidilegge,dataarrivo,oraarrivo,datapartenza,orapartenza,turno,codiceorganizzazione,servizio,note';
