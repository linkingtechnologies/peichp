...
$wt_short_title = 'MATERIALI ATTESI';
$wt_full_title = 'Materiali attesi';
...
if (camila_form_in_update_mode('segreteriacampo_worktable24')) {
    ...
    new form_textbox($form, 'categoria', 'CATEGORIA', false, 30, 255, '');
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori';
