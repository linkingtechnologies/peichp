...
$wt_short_title = 'OSPITI ATTESI';
$wt_full_title = 'Ospiti attesi';
...
if (camila_form_in_update_mode('segreteriacampo_worktable15')) {
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,cognome,nome,indirizzoresidenza,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
