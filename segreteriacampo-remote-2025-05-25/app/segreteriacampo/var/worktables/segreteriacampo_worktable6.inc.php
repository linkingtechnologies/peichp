...
$wt_short_title = 'DANNEGGIAMENTI';
$wt_full_title = 'Denunce danneggiamenti';
...
$form->fields['codicevolontario']->autosuggest_destfields = 'cognome,nome,organizzazione,cellulare';
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,numerosegnalazione,data1,cognome,nome,organizzazione,mezzoattrezzatura,cellulare,codicevolontario,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
