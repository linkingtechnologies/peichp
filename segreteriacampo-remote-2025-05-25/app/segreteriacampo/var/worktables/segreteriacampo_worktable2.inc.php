...
$wt_short_title = 'RICHIESTE';
$wt_full_title = 'Richieste';
...
$form->fields['assegnatariorichiesta']->autosuggest_destfields = '';
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,data1,richiedente,richiesta,tiporichiesta,priorit,assegnatariorichiesta,stato,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
