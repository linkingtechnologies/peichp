...
$wt_short_title = 'MOV. RISORSE';
$wt_full_title = 'Movimentazione risorse';
...
if (is_object($form->fields['dataora'])) $form->fields['dataora']->hslots = 60;
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,dataora,gruppo,risorsa,tiporisorsa,da,a1,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
