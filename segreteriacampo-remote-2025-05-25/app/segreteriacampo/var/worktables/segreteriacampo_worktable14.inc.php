...
$wt_short_title = 'MAGAZZINO';
$wt_full_title = 'Magazzino';
...
if (is_object($form->fields['tot'])) $form->fields['tot']->updatable = false;
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,prodotto,cod,udm,qtiniziale,tot as cf_formula_tot,c1,s,c2,s1,c3,s2,c4,s3,c5,s4,c6,s5,c7,s6,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
