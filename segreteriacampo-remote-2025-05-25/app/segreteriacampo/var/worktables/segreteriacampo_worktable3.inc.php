...
$wt_short_title = 'AVVISI';
$wt_full_title = 'Avvisi';
...
if (is_object($form->fields['dimensionetesto'])) $form->fields['dimensionetesto']->defaultvalue = worktable_parse_default_expression('22', $form);
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,data1,oggetto,testo,carattere,dimensionetitolo,dimensionetesto,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
