...
$wt_short_title = 'RUBRICA';
$wt_full_title = 'Rubrica';
...
$form->fields['cellulare']->autosuggest_destfields = 'nominativo';
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,nominativo,titolo,gruppoorganizzazioneente,ruolo,cellulare,email,telfisso,fax,altrotelefono,altrotelefono1,note,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
