...
$wt_short_title = 'MATERIALI';
$wt_full_title = 'Materiali';
...
if (camila_form_in_update_mode('segreteriacampo_worktable20')) {
    ...
    new form_textbox($form, 'provincia', 'PROVINCIA', false, 30, 2, '');

    
    new form_textbox($form, 'codiceinventario', 'CODICE INVENTARIO', false, 30, 255, '');

    
    new form_static_listbox($form, 'categoria', 'CATEGORIA', 'Non assegnata,Attrezzature speciali,Attrezzi vari,Container,Effetti letterecci,Generatori,Materiale AIB,Materiale antinquinante,Materiale elettrico,Materiale idraulico e idrogeologico,Radio e dispositivi TLC,Tende', false, '');

    
    new form_textbox($form, 'tipologia', 'TIPOLOGIA', true, 30, 100, '');
...
$form->fields['organizzazione']->autosuggest_infofields = 'provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori';
$form->fields['organizzazione']->autosuggest_pickfields = 'provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori';
$form->fields['organizzazione']->autosuggest_destfields = 'provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori';
}
...
$form->fields['provincia']->autosuggest_infofields = 'codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione';
$form->fields['provincia']->autosuggest_pickfields = 'codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione';
$form->fields['provincia']->autosuggest_destfields = 'codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione';
}
if (is_object($form->fields['codiceinventario']))
{
$form->fields['codiceinventario']->autosuggest_table = 'segreteriacampo_worktable24';
$form->fields['codiceinventario']->autosuggest_field = 'codiceinventario';
$form->fields['codiceinventario']->autosuggest_idfield = 'id';
$form->fields['codiceinventario']->autosuggest_infofields = 'categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia';
$form->fields['codiceinventario']->autosuggest_pickfields = 'categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia';
$form->fields['codiceinventario']->autosuggest_destfields = 'categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia';
}
if (is_object($form->fields['categoria']))
{
$form->fields['categoria']->autosuggest_table = 'segreteriacampo_worktable24';
$form->fields['categoria']->autosuggest_field = 'categoria';
$form->fields['categoria']->autosuggest_idfield = 'id';
$form->fields['categoria']->autosuggest_infofields = 'tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario';
$form->fields['categoria']->autosuggest_pickfields = 'tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario';
$form->fields['categoria']->autosuggest_destfields = 'tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario';
}
...
$form->fields['tipologia']->autosuggest_infofields = 'note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria';
$form->fields['tipologia']->autosuggest_pickfields = 'note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria';
$form->fields['tipologia']->autosuggest_destfields = 'note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria';
}
...
$form->fields['note']->autosuggest_infofields = 'marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia';
$form->fields['note']->autosuggest_pickfields = 'marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia';
$form->fields['note']->autosuggest_destfields = 'marca,modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia';
}
if (is_object($form->fields['marca']))
{
$form->fields['marca']->autosuggest_table = 'segreteriacampo_worktable24';
$form->fields['marca']->autosuggest_field = 'marca';
$form->fields['marca']->autosuggest_idfield = 'id';
$form->fields['marca']->autosuggest_infofields = 'modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note';
$form->fields['marca']->autosuggest_pickfields = 'modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note';
$form->fields['marca']->autosuggest_destfields = 'modello,codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note';
}
if (is_object($form->fields['modello']))
{
$form->fields['modello']->autosuggest_table = 'segreteriacampo_worktable24';
$form->fields['modello']->autosuggest_field = 'modello';
$form->fields['modello']->autosuggest_idfield = 'id';
$form->fields['modello']->autosuggest_infofields = 'codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca';
$form->fields['modello']->autosuggest_pickfields = 'codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca';
$form->fields['modello']->autosuggest_destfields = 'codiceorganizzazione,proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca';
}
...
$form->fields['codiceorganizzazione']->autosuggest_infofields = 'proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello';
$form->fields['codiceorganizzazione']->autosuggest_pickfields = 'proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello';
$form->fields['codiceorganizzazione']->autosuggest_destfields = 'proprietario,servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello';
}
if (is_object($form->fields['proprietario']))
{
$form->fields['proprietario']->autosuggest_table = 'segreteriacampo_worktable24';
$form->fields['proprietario']->autosuggest_field = 'proprietario';
$form->fields['proprietario']->autosuggest_idfield = 'id';
$form->fields['proprietario']->autosuggest_infofields = 'servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione';
$form->fields['proprietario']->autosuggest_pickfields = 'servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione';
$form->fields['proprietario']->autosuggest_destfields = 'servizio,turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione';
}
if (is_object($form->fields['servizio']))
{
$form->fields['servizio']->autosuggest_table = 'segreteriacampo_worktable24';
$form->fields['servizio']->autosuggest_field = 'servizio';
$form->fields['servizio']->autosuggest_idfield = 'id';
$form->fields['servizio']->autosuggest_infofields = 'turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario';
$form->fields['servizio']->autosuggest_pickfields = 'turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario';
$form->fields['servizio']->autosuggest_destfields = 'turno,noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario';
}
...
$form->fields['turno']->autosuggest_infofields = 'noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio';
$form->fields['turno']->autosuggest_pickfields = 'noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio';
$form->fields['turno']->autosuggest_destfields = 'noteulteriori,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio';
}
if (is_object($form->fields['noteulteriori']))
{
$form->fields['noteulteriori']->autosuggest_table = 'segreteriacampo_worktable24';
$form->fields['noteulteriori']->autosuggest_field = 'noteulteriori';
$form->fields['noteulteriori']->autosuggest_idfield = 'id';
$form->fields['noteulteriori']->autosuggest_infofields = 'organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno';
$form->fields['noteulteriori']->autosuggest_pickfields = 'organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno';
$form->fields['noteulteriori']->autosuggest_destfields = 'organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno';
}
    ...
    $form->draw();
      ...
      $report_fields = 'id,cf_bool_is_special,cf_bool_is_selected,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,dataoraregistrazione,dataorauscitadefinitiva,datainizioattestato,datafineattestato,noteulteriori,created,created_by,created_by_surname,created_by_name,last_upd,last_upd_by,last_upd_by_surname,last_upd_by_name,mod_num, uuid';
	  //$admin_report_fields = '';
      $default_fields = 'cf_bool_is_special,cf_bool_is_selected,organizzazione,provincia,codiceinventario,categoria,tipologia,note,marca,modello,codiceorganizzazione,proprietario,servizio,turno,dataoraregistrazione,dataorauscitadefinitiva,datainizioattestato,datafineattestato,noteulteriori';
      ...
      if ($_CAMILA['page']->camila_exporting())
          $mapping = 'created=Data creazione#last_upd=Ultimo aggiornamento#last_upd_by=Utente ult. agg.#last_upd_src=Sorgente Ult. agg.#last_upd_by_name=Nome Utente ult. agg.#last_upd_by_surname=Cognome Utente ult. agg.#mod_num=Num. mod.#id=Cod. riga#created_by=Utente creaz.#created_src=Sorgente creaz.#created_by_surname=Cognome Utente creaz.#created_by_name=Nome Utente creaz.#cf_bool_is_special=contrassegnati come speciali#cf_bool_is_selected=selezionati#organizzazione=ORGANIZZAZIONE#provincia=PROVINCIA#codiceinventario=CODICE INVENTARIO#categoria=CATEGORIA#tipologia=TIPOLOGIA#note=NOTE#marca=MARCA#modello=MODELLO#codiceorganizzazione=CODICE ORGANIZZAZIONE#proprietario=PROPRIETARIO#servizio=SERVIZIO#turno=TURNO#dataoraregistrazione=DATA/ORA REGISTRAZIONE#dataorauscitadefinitiva=DATA/ORA USCITA DEFINITIVA#datainizioattestato=DATA INIZIO ATTESTATO#datafineattestato=DATA FINE ATTESTATO#noteulteriori=NOTE ULTERIORI';
      else
          $mapping = 'created=Data creazione#last_upd=Ultimo aggiornamento#last_upd_by=Utente ult. agg.#last_upd_src=Sorgente Ult. agg.#last_upd_by_name=Nome Utente ult. agg.#last_upd_by_surname=Cognome Utente ult. agg.#mod_num=Num. mod.#id=Cod. riga#created_by=Utente creaz.#created_src=Sorgente creaz.#created_by_surname=Cognome Utente creaz.#created_by_name=Nome Utente creaz.#cf_bool_is_special=contrassegnati come speciali#cf_bool_is_selected=selezionati#organizzazione=ORGANIZZAZIONE#provincia=PROVINCIA#codiceinventario=COD. INV.#categoria=CATEGORIA#tipologia=TIPOLOGIA#note=NOTE#marca=MARCA#modello=MODELLO#codiceorganizzazione=COD. ORGANIZZAZIONE#proprietario=PROPRIETARIO#servizio=SERVIZIO#turno=TURNO#dataoraregistrazione=DATA/ORA REG.#dataorauscitadefinitiva=DATA/ORA USCITA#datainizioattestato=DATA INIZIO ATTEST.#datafineattestato=DATA FINE ATTEST.#noteulteriori=NOTE ULTERIORI';
